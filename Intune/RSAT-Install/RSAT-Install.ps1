<#PSScriptInfo
    ...
    .DESCRIPTION 
        ...
        - To install RSAT features:
          ServiceUI.exe -process:explorer.exe %WINDIR%\SysNative\WindowsPowerShell\v1.0\powershell.exe -NoLogo -NoProfile -NonInteractive -WindowStyle Hidden -ExecutionPolicy Bypass -File "install-rsat.ps1" -install
        - To uninstall RSAT features:
          ServiceUI.exe -process:explorer.exe %WINDIR%\SysNative\WindowsPowerShell\v1.0\powershell.exe -NoLogo -NoProfile -NonInteractive -WindowStyle Hidden -ExecutionPolicy Bypass -File "install-rsat.ps1" -uninstall
    .Update
...
try {
    ...
    $icon.Location = '10,10'
    $icon.SizeMode = 'Zoom'
    $icon.Image = [Drawing.Image]::FromFile("$($PWD)\Administrative-Tools.png")
    ...
    $titel.Size = New-Object System.Drawing.Size(400,20)
    $titel.Text = 'RSAT Installer | https://michaelsendpoint.com'
...
# ------------------------------------------------- Titel Icon
                ...
                $progressicon = New-Object System.Windows.Forms.PictureBox
                $progressicon.Size = '16,16'
                $progressicon.Location = '10,10'
                $progressicon.SizeMode = 'Zoom'
                $progressicon.Image = [Drawing.Image]::FromFile("$($PWD)\Administrative-Tools.png")
                $progressForm.Controls.Add($progressicon)

                # Title Label
                $progressTitle = New-Object System.Windows.Forms.Label
                $progressTitle.Location = New-Object System.Drawing.Point(30, 10)
                $progressTitle.Size = New-Object System.Drawing.Size(400, 20)
                $progressTitle.Text = 'RSAT Installer | https://michaelsendpoint.com'
                $progressTitle.Font = New-Object System.Drawing.Font('Verdana', 10)
                ...
                $finishButton.Location = New-Object System.Drawing.Point(370, 150)
                ...
                $finishButton.Font = New-Object System.Drawing.Font('Segoe UI', 14, [System.Drawing.FontStyle]::Bold)
                $Cancelbutton.FlatAppearance.MouseOverBackColor = "#3399FF"
